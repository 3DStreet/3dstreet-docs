...
**Feb 2026 Update:** This blog post is out of date as it references our legacy `quadjr` Gaussian splat renderer. We have since upgraded Gaussian splat rendering to use the `Spark` three.js renderer with these same depth sorting features and more. **[Refer to the February 2026 product update post for more information](/blog/2026/02/14/product-update-ai-video-gallery-and-more#gaussian-splat-rendering-with-spark)**.
