...
Due to high user demand, AI rendering is now built directly into 3DStreet — you can generate photorealistic images and videos from the Editor's snapshot dialog or the dedicated AI Generator app, without piping screenshots through external tools. See the current [AI Rendering documentation](/docs/key-features/ai-rendering) for the supported workflow. We're keeping this post for historical context.
:::
