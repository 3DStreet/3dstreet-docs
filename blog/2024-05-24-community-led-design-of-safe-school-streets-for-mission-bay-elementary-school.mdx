...
In San Francisco's Mission Bay neighborhood, community leaders used 3DStreet's rapid prototyping service to create a 3D digital twin of proposed street safety improvements around a new elementary school, helping them effectively advocate for the project with city officials and stakeholders.
        ...
        <img-comparison-slider>
          <img
            slot="first"
            width="100%"
            src="https://3dstreet.github.io/custom-scene-assets/mission-bay-1.jpg"
          />
          <img
            slot="second"
            width="100%"
            src="https://3dstreet.github.io/custom-scene-assets/mission-bay-2.jpg"
          /> 
        </img-comparison-slider>
...
## Adding High Fidelity Realism

Our new AI Rendering technology directly integrated into 3DStreet allows for finishing touches, following the guidance of the protected traffic circle geometry to create a high fidelity mockup.
        <img-comparison-slider>
          <img
            slot="first"
            width="100%"
          ...
          <img
            slot="second"
            width="100%"
            src="https://3dstreet.github.io/custom-scene-assets/mission-bay-traffic-circle-rev5.jpg"
          /> 
        </img-comparison-slider>
